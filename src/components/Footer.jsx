    ...
    <div className='whole footer mx-60 mt-8'>
      <div className='flex justify-between'>
        <div className='flex gap-5'>
          <NavLink to = "/map"><h3 className='text-base hover:underline cursor-pointer' >
            Map
          </h3></NavLink>
          <h3 className='text-base hover:underline cursor-pointer'>
            Dashboard
          </h3>
          <h3 className='text-base hover:underline cursor-pointer'>
            Newsletter
      ...
      <div className='flex col justify-between mt-6 -mr-16'>
